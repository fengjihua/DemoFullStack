...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      lightbox2:      [   '../libs/jquery/lightbox2/dist/js/lightbox.min.js',
                          '../libs/jquery/lightbox2/dist/css/lightbox.min.css']
  ...
  .constant('MODULE_CONFIG', [
      ...
      },
      {
          name: 'ngAside',
          files: [
              '../libs/angular/angular-aside/js/angular-aside.admin.min.js',
              '../libs/angular/angular-aside/css/angular-aside.min.css'
          ]
      }
    ]
  )
